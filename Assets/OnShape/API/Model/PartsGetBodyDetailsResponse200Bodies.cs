...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PartsGetBodyDetailsResponse200Bodies {
    /// <summary>
    /// Vertices of part
    /// </summary>
    ...
    public List<PartsGetBodyDetailsResponse200Edges> Edges { get; set; }
    ...
    public List<PartsGetBodyDetailsResponse200Faces> Faces { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PartsGetBodyDetailsResponse200Bodies {\n");
