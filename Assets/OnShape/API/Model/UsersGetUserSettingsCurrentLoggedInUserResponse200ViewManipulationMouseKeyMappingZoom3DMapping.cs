...
namespace IO.Swagger.Model {
  ...
  /// <summary>
  /// Set of button and key presses             that zooms in 3D
  /// </summary>
  [DataContract]
  public class UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingZoom3DMapping {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingZoom3DMapping {\n");
