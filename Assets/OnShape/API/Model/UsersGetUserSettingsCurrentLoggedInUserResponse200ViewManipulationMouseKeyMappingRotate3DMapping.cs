...
namespace IO.Swagger.Model {
  ...
  /// <summary>
  /// Set of button and key presses             that rotates in 3D
  /// </summary>
  [DataContract]
  public class UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingRotate3DMapping {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingRotate3DMapping {\n");
