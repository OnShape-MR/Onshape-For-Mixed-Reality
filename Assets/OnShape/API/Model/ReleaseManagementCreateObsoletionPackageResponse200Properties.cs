...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ReleaseManagementCreateObsoletionPackageResponse200Properties {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class ReleaseManagementCreateObsoletionPackageResponse200Properties {\n");
