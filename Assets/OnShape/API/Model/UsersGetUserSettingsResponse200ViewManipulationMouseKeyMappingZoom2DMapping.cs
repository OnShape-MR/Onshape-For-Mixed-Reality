...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class UsersGetUserSettingsResponse200ViewManipulationMouseKeyMappingZoom2DMapping {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UsersGetUserSettingsResponse200ViewManipulationMouseKeyMappingZoom2DMapping {\n");
