...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class AppElementsCreateReferenceBody {
    /// <summary>
    /// An optional sketch feature id within the target element that should be           tracked
    /// </summary>
    /// <value>An optional sketch feature id within the target element that should be           tracked</value>
    ...
    /// </summary>
    /// <value>The Id of the document of the element that is or contains the target           of the reference</value>
    ...
    /// </summary>
    /// <value>If not blank, specifies the configuration of the element.           Otherwise, the configuration is the default configuration for the element.</value>
    ...
    /// </summary>
    /// <value>Id of the transaction in which the reference creation should occur</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class AppElementsCreateReferenceBody {\n");
