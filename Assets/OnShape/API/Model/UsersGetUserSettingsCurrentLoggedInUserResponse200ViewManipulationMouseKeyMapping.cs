...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMapping {
    /// <summary>
    ...
    public List<UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingZoom2DMapping> Zoom2DMapping { get; set; }
    ...
    public List<UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingZoom3DMapping> Zoom3DMapping { get; set; }
    ...
    public List<UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingRotate3DMapping> Rotate3DMapping { get; set; }
    ...
    public List<UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingPan3DMapping> Pan3DMapping { get; set; }
    ...
    public List<UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingPan2DMapping> Pan2DMapping { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMapping {\n");
