...
namespace IO.Swagger.Model {
  ...
  /// <summary>
  /// A share entry for the folder specific to an entity
  /// </summary>
  [DataContract]
  public class DocumentsShareDocumentResponse200Entries {
    /// <summary>
    /// For internal use
    /// </summary>
    ...
    /// </summary>
    /// <value>The name of the entity that the document is shared with</value>
    ...
    /// </summary>
    /// <value>The ID of the parent folder</value>
    ...
    /// </summary>
    /// <value>The permissions for the parent folder that      have been granted to the entity.</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class DocumentsShareDocumentResponse200Entries {\n");
