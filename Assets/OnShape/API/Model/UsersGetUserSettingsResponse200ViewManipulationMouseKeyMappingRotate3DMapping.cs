...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class UsersGetUserSettingsResponse200ViewManipulationMouseKeyMappingRotate3DMapping {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UsersGetUserSettingsResponse200ViewManipulationMouseKeyMappingRotate3DMapping {\n");
