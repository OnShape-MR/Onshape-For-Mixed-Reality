...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PartsUpdatePartMetadataBody {
    /// <summary>
    /// Part vendor
    /// </summary>
    ...
    /// </summary>
    /// <value>Part name (Can be only modified in workspace)</value>
    ...
    public PartsUpdatePartMetadataBodyAppearance Appearance { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PartsUpdatePartMetadataBody {\n");
