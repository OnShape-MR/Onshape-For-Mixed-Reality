...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class WebhooksUpdateWebhookBody {
    /// <summary>
    ...
    /// </summary>
    /// <value>ID of webhook to update (must match webhookid in path parameter)</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class WebhooksUpdateWebhookBody {\n");
