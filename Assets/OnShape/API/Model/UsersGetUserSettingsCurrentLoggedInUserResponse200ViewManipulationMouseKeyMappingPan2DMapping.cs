...
namespace IO.Swagger.Model {
  ...
  /// <summary>
  /// Set of button and key presses that             pans in 2D
  /// </summary>
  [DataContract]
  public class UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingPan2DMapping {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UsersGetUserSettingsCurrentLoggedInUserResponse200ViewManipulationMouseKeyMappingPan2DMapping {\n");
