...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PartStudiosGetBodyDetailsResponse200Faces {
    /// <summary>
    /// Gets or Sets Box
    /// </summary>
    ...
    public PartStudiosGetBodyDetailsResponse200Surface Surface { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PartStudiosGetBodyDetailsResponse200Faces {\n");
