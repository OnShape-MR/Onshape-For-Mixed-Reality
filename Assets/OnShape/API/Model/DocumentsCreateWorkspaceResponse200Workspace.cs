...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class DocumentsCreateWorkspaceResponse200Workspace {
    /// <summary>
    ...
    public DocumentsCreateWorkspaceResponse200WorkspaceLastModifier LastModifier { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class DocumentsCreateWorkspaceResponse200Workspace {\n");
