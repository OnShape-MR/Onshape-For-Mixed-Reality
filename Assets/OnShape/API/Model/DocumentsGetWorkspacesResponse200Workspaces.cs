...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class DocumentsGetWorkspacesResponse200Workspaces {
    /// <summary>
    ...
    /// </summary>
    /// <value>Document microversion ID that is the root of the             workspace branch</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class DocumentsGetWorkspacesResponse200Workspaces {\n");
