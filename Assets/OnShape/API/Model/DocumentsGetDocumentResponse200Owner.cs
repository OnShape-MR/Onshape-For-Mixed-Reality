...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class DocumentsGetDocumentResponse200Owner {
    /// <summary>
    ...
    /// </summary>
    /// <value>Owner's user type, which can be: 0: user 1: company 2: Onshape</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class DocumentsGetDocumentResponse200Owner {\n");
