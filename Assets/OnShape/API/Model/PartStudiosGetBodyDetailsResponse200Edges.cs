...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PartStudiosGetBodyDetailsResponse200Edges {
    /// <summary>
    ...
    public PartStudiosGetBodyDetailsResponse200Curve Curve { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PartStudiosGetBodyDetailsResponse200Edges {\n");
