...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class AccountsGetPlanPurchasesResponse200Items {
    /// <summary>
    /// Plan name
    /// </summary>
    ...
    /// </summary>
    /// <value>List of subscribers included in this individual purchase</value>
    [DataMember(Name="subscribers", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "subscribers")]
    public List<AccountsGetPlanPurchasesResponse200Subscribers> Subscribers { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class AccountsGetPlanPurchasesResponse200Items {\n");
