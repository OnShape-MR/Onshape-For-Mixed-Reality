...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class FeatureStudiosCreateFeatureStudioResponse200 {
    /// <summary>
    /// Angle units, for Part Studio elements only
    /// </summary>
    /// <value>Angle units, for Part Studio elements only</value>
    ...
    public Object ThumbnailInfo { get; set; }

    /// <summary>
    /// Length units, for Part Studio elements only
    /// </summary>
    /// <value>Length units, for Part Studio elements only</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class FeatureStudiosCreateFeatureStudioResponse200 {\n");
