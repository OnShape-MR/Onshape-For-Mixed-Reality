...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PartStudiosGetMetadataResponse200Appearance {
    /// <summary>
    /// Part opacity
    /// </summary>
    ...
    public PartStudiosGetMetadataResponse200AppearanceColor Color { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PartStudiosGetMetadataResponse200Appearance {\n");
