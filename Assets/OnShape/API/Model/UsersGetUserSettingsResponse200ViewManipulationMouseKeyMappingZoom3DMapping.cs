...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class UsersGetUserSettingsResponse200ViewManipulationMouseKeyMappingZoom3DMapping {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UsersGetUserSettingsResponse200ViewManipulationMouseKeyMappingZoom3DMapping {\n");
