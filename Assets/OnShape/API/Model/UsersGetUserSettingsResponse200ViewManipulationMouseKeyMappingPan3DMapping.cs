...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class UsersGetUserSettingsResponse200ViewManipulationMouseKeyMappingPan3DMapping {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UsersGetUserSettingsResponse200ViewManipulationMouseKeyMappingPan3DMapping {\n");
