...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ElementsUpdateElementMetadataResponse200 {
    /// <summary>
    ...
    public ElementsUpdateElementMetadataResponse200CustomProperties CustomProperties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ElementsUpdateElementMetadataResponse200 {\n");
