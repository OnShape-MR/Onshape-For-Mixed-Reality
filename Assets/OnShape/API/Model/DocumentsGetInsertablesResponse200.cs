...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class DocumentsGetInsertablesResponse200 {
    /// <summary>
    /// Array of insertables
    /// </summary>
    /// <value>Array of insertables</value>
    [DataMember(Name="items", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "items")]
    public List<DocumentsGetInsertablesResponse200Items> Items { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class DocumentsGetInsertablesResponse200 {\n");
