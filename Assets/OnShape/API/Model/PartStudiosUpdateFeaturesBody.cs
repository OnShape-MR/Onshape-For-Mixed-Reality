...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PartStudiosUpdateFeaturesBody {
    /// <summary>
    ...
    /// </summary>
    /// <value>If true, suppression attributes of the feature         (suppress, suppressionState) will be updated</value>
    [DataMember(Name="updateSuppressionAttributes", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "updateSuppressionAttributes")]
    public bool? UpdateSuppressionAttributes { get; set; }

    /// <summary>
    /// A list of features containing updates to apply
    /// </summary>
    /// <value>A list of features containing updates to apply</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class PartStudiosUpdateFeaturesBody {\n");
      ...
      sb.Append("  UpdateSuppressionAttributes: ").Append(UpdateSuppressionAttributes).Append("\n");
