...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ReleaseManagementCreateReleasePackageResponse200 {
    /// <summary>
    ...
    /// </summary>
    /// <value>Primary Version ID of items in the release package if releasing from             a version</value>
    ...
    /// </summary>
    /// <value>Primary Workspace ID of items in the release package if releasing             from a workspace</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class ReleaseManagementCreateReleasePackageResponse200 {\n");
