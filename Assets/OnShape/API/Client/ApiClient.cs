...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        public string BasePath { get; set; } = "https://cad.onshape.com/api";

        public readonly DocumentsApi Documents;
        public readonly PartsApi Parts;
        public readonly PartStudiosApi PartStudios;
            ...
            foreach (string auth in authSettings)
            {
                ...
                switch(auth)
                {
                    case "OAuth2":
                        ...
                        break;
                    case "apiAccessKey":
                        headerParams["ACCESS_KEY"] = GetApiKeyWithPrefix("ACCESS_KEY");
                        
                        break;
                    case "apiSecretKey":
                        headerParams["SECRET_KEY"] = GetApiKeyWithPrefix("SECRET_KEY");
